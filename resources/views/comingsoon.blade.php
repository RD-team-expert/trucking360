...
@section('content')
    ...
    <style>
        .enhanced-gradient {
            ...
            opacity: 0.8;
            /* Adjust opacity for gradient to display the video */
    ...
    <div
        ...
        <video autoplay muted loop class="video-background tablet-video">
            <source src="{{ asset('website/img/dashboardtablet.mp4') }}" type="video/mp4" />
            Your browser does not support the video tag.
        </video>

        <!-- Background Elements -->
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -left-1/4 -top-1/4 w-1/2 h-1/2 bg-[#e93232]/20 rounded-full blur-3xl animate-pulse-slow">
            </div>
            <div class="absolute -right-1/4 -bottom-1/4 w-3/4 h-3/4 bg-[#2e368f]/20 rounded-full blur-3xl animate-pulse-slow"
        ...
        <div class="flex flex-col md:flex-row items-center justify-center flex-grow">
            ...
            <div class="md:w-1/2 flex justify-center items-center opacity-0" id="rocketSection" style="visibility: hidden;">
                <div class="relative">
                    <div
                        class="w-64 h-64 md:w-96 md:h-96 bg-white/20 rounded-full flex items-center justify-center animate-float opacity-75">
                        <img class="md:opacity-100" src="{{ asset('website/img/360logo.png') }}" alt=""
                            style="width: 250px ;">
                    </div>
                </div>
            </div>
